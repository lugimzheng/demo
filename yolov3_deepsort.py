...
class VideoTracker(object):
    def __init__(self, cfg, args, video_path, video_path_depth, face_path):
        self.cfg = cfg
        self.args = args
...
if __name__ == "__main__":
    ...
    with VideoTracker(cfg, args, video_path=args.VIDEO_PATH, video_path_depth=args.VIDEO_PATH_Depth,
